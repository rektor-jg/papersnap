...
export const TrashList: React.FC<TrashListProps> = ({ 
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
            {documents.length > 0 && (
                ...
                className="inline-flex items-center px-4 py-2 bg-red-50 text-red-600 border border-red-100 rounded-xl text-sm font-bold hover:bg-red-100 transition-all"
                >
      ...
      {/* Toolbar */}
      <div className="bg-white p-2 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.03)] border border-gray-100 flex items-center">
                  ...
                  <tr key={doc.id} className="hover:bg-gray-50/80 transition-colors group">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="h-9 w-9 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 text-xs font-bold mr-3 border border-gray-200">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div className="flex justify-end gap-3">
                            <button 
                                ...
                                className="text-indigo-600 hover:text-indigo-900 font-semibold px-3 py-1.5 rounded-lg bg-indigo-50 hover:bg-indigo-100 transition-colors flex items-center text-xs"
                            >
